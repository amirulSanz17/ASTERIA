        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap"><?php echo e($user->nama); ?></td>
                    <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap"><?php echo e($user->id_user); ?></td>
                    <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap"><?php echo e($user->jabatan); ?></td>
                    <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">
                        <form action="<?php echo e(route('superadmin.updateRole', $user->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
                            <select name="role"
                                class="px-2 py-1 border rounded"
                                onchange="this.form.submit()">
                                <?php $__currentLoopData = ['Admin Riksa Uji', 'Tim Riksa Uji', 'Penyusun LHP']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">
                         <form action="<?php echo e(route('superadmin.destroyUser', $user->id)); ?>" method="POST" onsubmit='return confirm("Yakin menghapus pengguna dengan nama \"<?php echo e($user->nama); ?>\"? Data yang dihapus tidak dapat dikembalikan!");'>
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="submit" class="flex p-2 transition-all duration-500 rounded-full group item-center">
                            <a href="#">
...
<?php /**PATH C:\laragon\www\asteria\resources\views/superadmin/index.blade.php ENDPATH**/ ?>